...
## 更新摘要
**变更内容**   
- 移除了所有关于已删除的file_reader技能的相关内容
- 更新了技能架构图以反映当前可用的内置技能
- 删除了文件读取相关的性能考虑和调试指南
- 更新了典型技能开发示例，专注于现有的canvas、image和video技能
...
- 参考文件：[image_tools SKILL.md（内置）:1-77](file://backend/skills/active_skills/image_tools/SKILL.md#L1-L77)

**章节来源**
- [image_tools SKILL.md（内置）:15-77](file://backend/skills/active_skills/image_tools/SKILL.md#L15-L77)

#### 示例三：视频编辑技能
- 目标：提供 generate_video 与 edit_video 工具的使用说明与异步流程
- 关键点：异步任务、模式区分（编辑/扩展）、参数枚举与质量选项
- 参考文件：[video_tools SKILL.md（内置）:1-101](file://backend/skills/active_skills/video_tools/SKILL.md#L1-L101)

**章节来源**
- [video_tools SKILL.md（内置）:17-101](file://backend/skills/active_skills/video_tools/SKILL.md#L17-L101)
