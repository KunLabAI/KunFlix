...
## 更新摘要
**变更内容**
- 新增ThinkPanel组件：专门用于显示AI思考过程的可视化面板
- 增强拖拽功能：支持从画布节点拖拽到AI面板，以及从AI面板内容拖拽到画布
- ChatMessage组件重构：集成ThinkPanel，提供更好的思考过程可视化
- 新增拖拽工具函数：支持多种节点类型的拖拽操作
- 组件间交互优化：AI面板与画布之间的双向拖拽支持
- 思考过程状态管理：完善单智能体和多智能体思考过程的状态跟踪
...
- **新增ThinkPanel组件**：专门用于显示AI思考过程的可视化面板
- **增强拖拽功能**：支持从画布节点拖拽到AI面板，以及从AI面板内容拖拽到画布
- **组件重构优化**：ChatMessage组件集成ThinkPanel，提供更好的思考过程可视化
...
### 扩展开发指南
- **新增思考面板功能**：参考ThinkPanel的实现，为其他组件添加思考过程可视化
