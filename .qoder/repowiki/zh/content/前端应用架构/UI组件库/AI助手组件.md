...
## 更新摘要
**变更内容**
- MessageInput组件移除了Framer Motion动画，提升了组件性能
...
**图表来源**
- [AIAssistantPanel.tsx:1-407](file://frontend/src/components/canvas/AIAssistantPanel.tsx#L1-L407)
...
- 输入组件：支持回车发送、Shift+Enter 换行、禁用态与加载态反馈，**已移除Framer Motion动画，提升性能**
...
**章节来源**
- [AIAssistantPanel.tsx:14-407](file://frontend/src/components/canvas/AIAssistantPanel.tsx#L14-L407)
...
- ESC 关闭面板，拖拽调整面板位置
- **性能优化**：移除了Framer Motion动画，减少了不必要的DOM操作和重绘
...
- **性能优化**：MessageInput组件移除了Framer Motion动画，减少了DOM操作和重绘开销
