...
## 更新摘要
**变更内容**
- 新增多附件支持系统：支持拖拽附件到AI面板、多图附件预览、附件上下文构建
- 新增附件预览组件：NodePreviewCard和NodePreviewList提供直观的附件预览体验
- 新增附件拖拽功能：从画布节点拖拽到AI面板，支持多节点同时拖拽
- 新增附件上下文构建：将附件信息构建为AI可理解的上下文内容
- 改进主题变量使用：优化CSS变量和主题色的使用方式
- 新增附件数量限制：最多支持5个附件的限制机制
...
- **附件系统扩展**
  ...
  - 参考路径：[nodeAttachmentUtils.ts:24-81](file://frontend/src/lib/nodeAttachmentUtils.ts#L24-L81)，[AIAssistantPanel.tsx:27-33](file://frontend/src/components/canvas/AIAssistantPanel.tsx#L27-L33)，[useNodeDragToAI.ts:93-101](file://frontend/src/app/theater/[id]/hooks/useNodeDragToAI.ts#L93-L101)
