...
视频生成API是Infinite Narrative Theater项目的核心功能模块之一，提供基于多供应商平台的视频生成服务。该API支持多种视频生成模式，包括文本到视频、图片到视频和视频编辑，并集成了完整的计费系统、任务管理和状态轮询机制。
...
该API为Infinite Narrative Theater项目提供了强大的视频生成功能，为用户创造沉浸式的互动体验奠定了坚实的技术基础。新的供应商管理架构、后台管理界面、模型能力配置系统和任务删除功能使得视频生成服务更加灵活和可控，为系统管理员提供了强大的管理工具，为用户提供了一致的视频生成体验。