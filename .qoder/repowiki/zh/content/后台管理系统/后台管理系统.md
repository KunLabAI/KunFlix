...
## 更新摘要
**所做更改**
- **视频管理界面重大UI重构**：从传统的表格布局完全重构为现代化的卡片布局设计
- **新增页面化创建流程**：视频任务创建从表单集成改为独立页面，提供更清晰的分步创建体验
- **增强的交互设计**：卡片悬停效果、状态标签、操作遮罩、删除按钮等UI增强功能
- **改进的预览功能**：独立的视频预览模态框，支持全屏播放和详细信息查看
- **响应式网格布局**：支持不同屏幕尺寸的自适应卡片排列
- **实时状态轮询优化**：针对活跃任务的智能轮询机制
...
## 简介
本后台管理系统面向"无限叙事游戏"项目，提供管理员端的统一管理能力，现已全面升级，包括：
...
- [backend/routers/videos.py](file://backend/routers/videos.py#L1-L277)
- [backend/services.py](file://backend/services.py#L1-L66)
- [backend/services/orchestrator.py](file://backend/services/orchestrator.py#L76-L712)
...
- [backend/schemas.py](file://backend/schemas.py#L1-L606)
...
- [backend/models.py](file://backend/models.py#L9-L382)
- [backend/schemas.py](file://backend/schemas.py#L1-L606)
...
- [backend/routers/chats.py](file://backend/routers/chats.py#L1-L275)
- [backend/routers/videos.py](file://backend/routers/videos.py#L1-L277)
- [backend/auth.py](file://backend/auth.py#L107-L173)
...
**图表来源**
- [backend/routers/admin.py](file://backend/routers/admin.py#L29-L135)
...
**图表来源**
- [backend/routers/admin_auth.py](file://backend/routers/admin_auth.py#L33-L119)
...
**图表来源**
- [backend/admin/src/app/admin/subscriptions/page.tsx](file://backend/admin/src/app/admin/subscriptions/page.tsx#L165-L189)

**章节来源**
- [backend/admin/src/app/admin/subscriptions/page.tsx](file://backend/admin/src/app/admin/subscriptions/page.tsx#L1-L522)
- [backend/admin/src/hooks/useSubscriptions.ts](file://backend/admin/src/hooks/useSubscriptions.ts#L1-L39)
...
**图表来源**
- [backend/routers/admin.py](file://backend/routers/admin.py#L141-L214)
...
**章节来源**
- [backend/routers/llm_config.py](file://backend/routers/llm_config.py#L1-L203)
- [backend/models.py](file://backend/models.py#L137-L138)
...
**图表来源**
- [backend/services/orchestrator.py](file://backend/services/orchestrator.py#L581-L712)
...
API->>Service : poll_video_task(api_key, xai_task_id)
...
**图表来源**
- [backend/routers/videos.py](file://backend/routers/videos.py#L23-L226)
- [backend/services/video_generation.py](file://backend/services/video_generation.py#L134-L181)
- [backend/services/billing.py](file://backend/services/billing.py#L290-L324)
...
**章节来源**
- [backend/routers/videos.py](file://backend/routers/videos.py#L25-L70)
- [backend/models.py](file://backend/models.py#L352-L382)
...
**章节来源**
- [backend/admin/src/app/admin/videos/page.tsx](file://backend/admin/src/app/admin/videos/page.tsx#L55-L209)
- [backend/admin/src/app/admin/videos/VideoPreviewModal.tsx](file://backend/admin/src/app/admin/videos/VideoPreviewModal.tsx#L20-L93)
...
**章节来源**
- [backend/admin/src/components/admin/AdminLayout.tsx](file://backend/admin/src/components/admin/AdminLayout.tsx#L45-L91)
...
### LLM提供商标签系统
- **功能特性**
  - 标签化管理：支持为LLM提供商添加多个标签，便于分类和筛选
  - 实时筛选：在供应商列表中显示标签，支持按标签快速查找
  - 交互式输入：支持键盘输入和回车添加标签，删除键删除最后一个标签
  - 数据持久化：标签数据存储在数据库中，支持编辑和更新
- **设计实现**
  - 前端使用Badge组件展示标签，支持点击删除
  - 表单验证确保标签格式正确
  - 后端模型支持JSON格式存储标签数组

**章节来源**
- [backend/admin/src/app/admin/llm/page.tsx](file://backend/admin/src/app/admin/llm/page.tsx#L413-L463)
...
**章节来源**
- [backend/admin/src/components/admin/agents/AgentForm/index.tsx](file://backend/admin/src/components/admin/agents/AgentForm/index.tsx#L1-L296)
- [backend/admin/src/components/admin/agents/AgentForm/schema.ts](file://backend/admin/src/components/admin/agents/AgentForm/schema.ts#L1-L70)
- [backend/admin/src/components/admin/agents/AgentForm/BasicInfo.tsx](file://backend/admin/src/components/admin/agents/AgentForm/BasicInfo.tsx#L1-L180)
- [backend/admin/src/components/admin/agents/AgentForm/Tools.tsx](file://backend/admin/src/components/admin/agents/AgentForm/Tools.tsx#L1-L100)
- [backend/admin/src/components/admin/agents/AgentForm/LeaderConfig.tsx](file://backend/admin/src/components/admin/agents/AgentForm/LeaderConfig.tsx#L1-L214)
...
**章节来源**
- [backend/admin/src/app/admin/llm/page.tsx](file://backend/admin/src/app/admin/llm/page.tsx#L506-L643)
...
**章节来源**
- [backend/services/video_generation.py](file://backend/services/video_generation.py#L37-L100)
- [backend/routers/videos.py](file://backend/routers/videos.py#L23-L104)
- [backend/schemas.py](file://backend/schemas.py#L551-L568)
...
**图表来源**
- [backend/admin/src/app/admin/videos/page.tsx](file://backend/admin/src/app/admin/videos/page.tsx#L122-L205)
...
**章节来源**
- [backend/admin/src/app/admin/videos/new/page.tsx](file://backend/admin/src/app/admin/videos/new/page.tsx#L1-L258)
...
**章节来源**
- [backend/main.py](file://backend/main.py#L30-L41)
- [backend/routers/*.py](file://backend/routers/admin.py#L1-L498)
...
- [backend/migrations/versions/h4i5j6k7l8m9_add_model_costs_and_subscriptions.py](file://backend/migrations/versions/h4i5j6k7l8m9_add_model_costs_and_subscriptions.py#L28-L44)
- [backend/migrations/versions/7459f2d26782_add_video_tasks_and_video_agent_fields.py](file://backend/migrations/versions/7459f2d26782_add_video_tasks_and_video_agent_fields.py#L50-L54)
- [backend/services/billing.py](file://backend/services/billing.py#L22-L35)
- [backend/admin/src/hooks/useVideoTasks.ts](file://backend/admin/src/hooks/useVideoTasks.ts#L34-L48)
...
- [backend/routers/chats.py](file://backend/routers/chats.py#L112-L258)
- [backend/routers/admin.py](file://backend/routers/admin.py#L220-L279)
- [backend/routers/videos.py](file://backend/routers/videos.py#L107-L226)
- [backend/services/billing.py](file://backend/services/billing.py#L290-L324)
- [backend/admin/src/hooks/useVideoTasks.ts](file://backend/admin/src/hooks/useVideoTasks.ts#L34-L48)
...
- [backend/admin/src/app/admin/llm/page.tsx](file://backend/admin/src/app/admin/llm/page.tsx#L1-L738)
- [backend/admin/src/app/admin/videos/page.tsx](file://backend/admin/src/app/admin/videos/page.tsx#L1-L268)
- [backend/admin/src/app/admin/videos/new/page.tsx](file://backend/admin/src/app/admin/videos/new/page.tsx#L1-L258)
- [backend/admin/src/context/AuthContext.tsx](file://backend/admin/src/context/AuthContext.tsx#L52-L95)
...
**章节来源**
- [backend/routers/admin.py](file://backend/routers/admin.py#L29-L498)
- [backend/routers/admin_auth.py](file://backend/routers/admin_auth.py#L33-L119)
...
- [backend/routers/videos.py](file://backend/routers/videos.py#L23-L277)
