...
## 引言
本项目是一个基于 AgentScope 多智能体框架、Next.js 16 前端、FastAPI 后端与 PostgreSQL 数据库的无限剧情游戏系统。系统通过 LLM 驱动的叙事引擎与多模态生成能力，为玩家提供沉浸式动态剧情体验；同时提供后台管理系统用于可视化管理玩家、剧情与 LLM 供应商配置。
...
- frontend：游戏客户端前端，基于 Next.js 16，使用 Pixi.js 进行 2D 渲染；
...
F_canvas["frontend/src/components/GameCanvas.tsx<br/>Pixi.js 渲染画布"]
