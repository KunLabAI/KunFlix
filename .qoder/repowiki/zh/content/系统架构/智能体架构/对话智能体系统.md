...
## 简介
本文件面向KunFlix对话智能体系统，聚焦DialogAgent类的设计与实现，系统性解析其继承自AgentBase的基础能力、ToolGuardMixin的安全防护机制以及MemoryCompactionHook的记忆压缩功能。文档将详细说明智能体初始化流程、系统提示词配置、消息格式化器映射机制、工具注册过程，并阐述智能体回复机制的完整流程（消息构建、格式化、模型调用、响应提取与记忆管理）。最后提供配置示例、性能优化建议与常见问题解决方案。
