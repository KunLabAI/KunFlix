...
**更新** 系统现已增强对AI助手多会话管理功能的国际化支持，包括新建对话、历史对话管理和删除对话等UI元素的本地化。
...
O --> P[PanelHeader.tsx - 面板头部]
O --> Q[useSessionManager.ts - 会话管理钩子]
end
```
...
**图表来源**
- [frontend/src/i18n/locales/zh-CN.json:2-224](file://frontend/src/i18n/locales/zh-CN.json#L2-L224)
- [frontend/src/i18n/locales/en-US.json:2-224](file://frontend/src/i18n/locales/en-US.json#L2-L224)
...
5. **占位符**：动态内容的占位符
6. **帮助信息**：用户指导和说明
7. **AI助手相关**：对话管理、欢迎消息、预设对话等

**章节来源**
- [frontend/src/i18n/locales/zh-CN.json:1-224](file://frontend/src/i18n/locales/zh-CN.json#L1-L224)
- [frontend/src/i18n/locales/en-US.json:1-224](file://frontend/src/i18n/locales/en-US.json#L1-L224)
...
**新增** 系统现已全面支持AI助手的多会话管理功能，包括以下新增的翻译键：
...
**图表来源**
- [frontend/src/i18n/locales/zh-CN.json:161-222](file://frontend/src/i18n/locales/zh-CN.json#L161-L222)
- [frontend/src/i18n/locales/en-US.json:161-222](file://frontend/src/i18n/locales/en-US.json#L161-L222)
...
**章节来源**
- [frontend/src/components/ai-assistant/PanelHeader.tsx:58-234](file://frontend/src/components/ai-assistant/PanelHeader.tsx#L58-L234)
- [frontend/src/components/ai-assistant/hooks/useSessionManager.ts:178-252](file://frontend/src/components/ai-assistant/hooks/useSessionManager.ts#L178-L252)
- [frontend/src/components/ai-assistant/WelcomeMessage.tsx:29-67](file://frontend/src/components/ai-assistant/WelcomeMessage.tsx#L29-L67)
...
S[Lucide Icons] --> T[图标显示]
end
subgraph "存储系统"
U[localStorage] --> V[语言偏好持久化]
end
A --> E
C --> G
C --> I
...
该国际化系统为应用的全球化发展奠定了坚实基础，通过持续的优化和扩展，能够满足不断增长的国际化需求。特别是新增的AI助手多会话管理功能国际化支持，为用户提供了更加完善和本地化的AI助手使用体验。