...
## 更新摘要
**所做更改**
- 新增画布节点类型权限管理功能，支持智能体控制特定节点类型
- 增强画布事件通知机制，新增canvas:edge:deleted事件
- 完善画布节点直接控制能力，支持智能体直接操作节点
- 优化画布存储架构，增强去重和本地持久化机制
- 改进实时协作功能，增强WebSocket事件处理
...
1. **节点类型权限管理**：智能体可以精确控制特定类型的画布节点
2. **画布事件通知**：完整的事件系统支持画布操作的实时通知
3. **增强的画布控制**：智能体可以直接操作画布节点
4. **优化的存储机制**：改进的去重和本地持久化功能
