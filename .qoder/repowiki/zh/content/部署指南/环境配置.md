...
## 简介
本指南面向开发与生产环境，提供从零到一的环境准备、数据库初始化、环境变量配置、Windows 特殊注意事项与 WSL 推荐实践，以及环境验证与常见错误排查方法。目标是帮助你在本地或服务器上快速、稳定地搭建无限剧情游戏系统的后端服务。
...
CheckPG --> CreateDB["创建数据库 infinite_game_db"]
