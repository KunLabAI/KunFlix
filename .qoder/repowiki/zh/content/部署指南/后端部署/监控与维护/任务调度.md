...
subgraph "业务层"
SERVICES["services.py<br/>TheaterService 编排"]
...
- 业务服务编排：TheaterService 负责玩家创建、世界初始化、章节生成等流程编排。
...
- 任务链路：以“章节初始化”为例，后台任务调用 TheaterService.init_world，进而通过 NarrativeEngine 生成章节内容并持久化。
...
TheaterService --> AsyncSessionLocal : "使用"
TheaterService --> StoryChapter : "持久化"
TheaterService --> Player : "读取/更新"
