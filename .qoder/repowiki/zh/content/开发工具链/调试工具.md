...
- 前端：React 客户端、WebSocket Hook、Pixi.js 游戏画布组件。
...
- [frontend/src/components/GameCanvas.tsx](file://frontend/src/components/GameCanvas.tsx#L10-L44)
...
ROUTERS --> SRV["服务层<br/>GameService"]
...
- Pixi.js 画布
  ...
  - 参考路径：[frontend/src/components/GameCanvas.tsx](file://frontend/src/components/GameCanvas.tsx#L14-L44)
...
- 前端渲染
  ...
  - 参考路径：[frontend/src/components/GameCanvas.tsx](file://frontend/src/components/GameCanvas.tsx#L39-L43)
