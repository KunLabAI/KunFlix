...
**重要变更**：系统已从传统的章节模型迁移到剧院模型，移除了用户遗留字段和故事章节表，引入了全新的剧场、节点和边的数据结构。
...
- [page.tsx:138-144](file://frontend/src/app/theater/[id]/page.tsx#L138-L144)
...
**重要变更说明**：
- 系统已完全从章节模型迁移到剧院模型
- 移除了用户遗留字段（current_chapter, personality_profile, inventory, relationships）
- 删除了 story_chapters 表
- 新增了 theaters, theater_nodes, theater_edges 三张核心表
- 前端组件已适配新的节点类型和数据结构
- API 接口已更新为剧场系统专用