...
## 更新摘要
**所做更改**
- 新增ImageGenConfigDialog组件，提供统一的图像生成配置界面
- 增强统一图像生成配置系统，支持动态供应商能力检测
- 改进前端组件以支持动态配置和实时能力展示
- 新增图像供应商能力API端点，支持动态能力获取
- 扩展配置适配器以支持更丰富的供应商能力映射
...
- [admin_tools.py:189-196](file://backend/routers/admin_tools.py#L189-L196)
...
- [ImageGenConfigDialog.tsx:99-102](file://backend/admin/src/components/admin/tools/ImageGenConfigDialog.tsx#L99-L102)
...
**图表来源**
- [ImageGenConfigDialog.tsx:73-82](file://backend/admin/src/components/admin/tools/ImageGenConfigDialog.tsx#L73-L82)
- [ImageGenConfigDialog.tsx:99-102](file://backend/admin/src/components/admin/tools/ImageGenConfigDialog.tsx#L99-L102)
- [ImageGenConfigDialog.tsx:104-132](file://backend/admin/src/components/admin/tools/ImageGenConfigDialog.tsx#L104-L132)
...
**图表来源**
- [image_config_adapter.py:134-182](file://backend/services/image_config_adapter.py#L134-L182)
...
## 结论
该图像生成系统通过重构统一配置系统和引入动态供应商能力检测，实现了更加灵活和可扩展的多供应商统一接入。统一配置适配器与计费服务进一步提升了系统的可维护性与可控性。新的架构支持更好的用户体验，通过前端动态能力检测提供智能配置界面。新增的ImageGenConfigDialog组件提供了直观的配置界面，支持动态供应商选择和实时能力展示。建议在生产环境中合理设置并发参数、监控供应商限流与内容审核策略，并定期清理本地媒体文件以控制存储空间。
...
- **动态供应商能力**
  ...
  - 图像供应商能力API：[admin_tools.py:189-196](file://backend/routers/admin_tools.py#L189-L196)
- **工具执行流程**
