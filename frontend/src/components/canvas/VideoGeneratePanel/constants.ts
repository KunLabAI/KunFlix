import type { RefType } from '../RefTagInput';
import type { PickerMode } from './types';

// Provider logo mapping — 与 ImageGeneratePanel 对齐
...
/** video_mode → PickerMode 映射 */
export const PICKER_MODE_MAP: Record<string, PickerMode> = {
  text_to_video: 'none',
